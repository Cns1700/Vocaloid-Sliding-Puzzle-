...
クリア後は証明書をダウンロードしたりコピーしたりできます。手動クリアは盤面の左の表に合わせたゴールド／シルバー／ブロンズです。オートソルブは「ランクなし」です。
...
トロフィーはこの端末の中だけの成績です。ゴールドは、そのグリッドサイズにしては速くて手数も抑えめ、という目安です。左の表に、その盤面のタイムと手数の条件が出ます。
