...
テーマは5つです。オリジナルミク、Supreme、Honey Whip、25時、VFlower V3。盤面は 3×3 から 8×8 までの正方形です。ギャラリーはサイコロ型ではなく、キャラごとに横一列のリストです。
...
クリア後は結果の証明書をダウンロードしたりコピーしたりできます。手動クリアはゴールド／シルバー／ブロンズで、同じカップのトロフィーを色だけ変えて使います。オートソルブは「ランクなし」です。手動クリアのあと、証明書の **Achieved By** 用に名前を選べます。パズル画面の横の表に、その盤面のタイムと手数の条件が出ます。今週のトロフィー数と週／月／年のコレクション証明書はホームにあります。
