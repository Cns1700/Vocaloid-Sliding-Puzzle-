...
初音ミク（いくつかのモジュール）と **Vブイフラワ V3** のイラストで遊ぶ、無料・非公式のスライディングパズルです。キャラを選んで絵を選んで、崩れたタイルを元の位置に戻してください。
...
| **クリア**<br>ランク、ダウンロード、コピー | **証明書**<br>トロフィー＋金 / 銀 / ブロンズ | **週間コレクション**<br>ダウンロードできる週次集計 |

## できること

テーマは5つです。オリジナルミク、シュプリーム、ハニーウィップ、25時、Vブイフラワ V3。盤面は 3×3 から 8×8 までの正方形です。ギャラリーはサイコロ型ではなく、キャラごとに横一列のリストです。
