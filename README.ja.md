...
クリア後は証明書をダウンロードしたりコピーしたりできます。手動クリアはゴールド／シルバー／ブロンズです。オートソルブは「ランクなし」です。今週のトロフィー数はホームと盤面の横に出ます。毎週月曜にリセットされます。
...
トロフィーはこの端末の中だけの成績です。ゴールドは、そのグリッドサイズにしては速くて手数も抑えめ、という目安です。横の窓に、今週何回ずつ取ったかが出ます。
